...
You are the host of a game of 21 questions.
...
this conclusion? For example, "They were born in 1943, which is after 1920", \
or "It was between the British and French, not the British and Russians".
2. If applicable, explain what makes the answer not fully straightforward — \
common misconceptions, edge cases, or context that complicates a simple \
yes/no.
3. Suggest how the player could rephrase or narrow their question to get a \
different answer. For example, "If you had asked whether they were born in \
Europe, the answer would be yes" or "If you had asked whether they were \
*ever* politically active, that would result in a more definitive answer".
...
Generate a single subject related to this topic that would work well as a \
21-questions answer. For most topics, this would be a notable figure, event, \
place, or concept.
...
specific. The player knows the topic but not the solution. The hints will be \
revealed one at a time as the player progresses through the game, so earlier \
hints should be subtle and later hints should make the answer much easier to \
guess.
